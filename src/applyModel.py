...
xPath = os.path.expanduser('~/Desktop/Better/kaggle/NCFM/data/X-Test-Tensor.json')
xArray, xName = processRawData(xPath)
xArray = xArray
xName = xName

checkPointPath = os.path.expanduser('~/Desktop/Better/kaggle/NCFM/src/parameters/model-v1.0.ckpt')
