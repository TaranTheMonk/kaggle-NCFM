...
def cnnModel(xTrain, xTest, yTrain, yTest, newModel=True, checkPointPath=None):
...
def main():
    ...
    xPath = os.path.expanduser('~/Desktop/Better/kaggle/NCFM/data/X-Tensor.json')
    yPath = os.path.expanduser('~/Desktop/Better/kaggle/NCFM/data/Y-Tensor.json')
    ...
    cnnModel(trainX, testX, trainY, testY, newModel=False, checkPointPath='./parameters/model-v1.0.ckpt')
